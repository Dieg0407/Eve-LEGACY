...
public class DaoSql {
    ...
    public DaoSql(Connection conexion, Class claseBean) throws BadDefinitionException {
    ...
    public Object obtenerRegistro(Object dato) throws WrongOperationException,BadDefinitionException,SQLException{
    ...
    public Object obtenerRegistro(List<Object> datos)throws WrongOperationException,BadDefinitionException,SQLException{
    ...
    public List<Object> listarTodos() throws BadDefinitionException,SQLException{
        List<Field> campos = new ArrayList<>();
        StringBuilder campoSeleccionados =  new StringBuilder();
    ...
    public List<Object> listarRegistros(List<Parametro> parametros) throws BadDefinitionException,SQLException{
        List<Field> campos = new ArrayList<>();
        StringBuilder campoSeleccionados =  new StringBuilder();
        this.construirSelect(campos,campoSeleccionados);
    ...
    public List<Object> listarRegistros(List<Parametro> parametros, Map<Field,Boolean> orderBy) throws BadDefinitionException,SQLException{
        List<Field> campos = new ArrayList<>();
        StringBuilder campoSeleccionados =  new StringBuilder();
        this.construirSelect(campos,campoSeleccionados);
    ...
    public void insertarRegistro(Object registro) throws IllegalArgumentException, BadDefinitionException,SQLException{
    ...
    public int borrarRegistros(List<Parametro> parametros) throws SQLException{
        int afectados;
    ...
    public int borrarTodos() throws SQLException{
        int afectados;
    ...
    public int actualizarRegistro(Object registro) throws IllegalArgumentException,BadDefinitionException,SQLException{
        if(!this.claseBean.isInstance(registro))
            throw new IllegalArgumentException("El objeto no es de la clase mapeada en el DAO");
    ...
    public int actualizarRegistro(Map<Field, Object> campos, List<Parametro> condiciones) throws SQLException{
        int registros;
